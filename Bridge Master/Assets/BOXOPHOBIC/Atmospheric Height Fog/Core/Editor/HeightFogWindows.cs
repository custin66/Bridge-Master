...
namespace AtmosphericHeightFog
{
    ...
    {
        [MenuItem("Window/BOXOPHOBIC/Atmospheric Height Fog/Discord Server", false, 2000)]
        public static void Discord()
        {
            Application.OpenURL("https://discord.com/invite/znxuXET");
        }

        [MenuItem("Window/BOXOPHOBIC/Atmospheric Height Fog/Documentation", false, 2001)]
        public static void Documentation()
        {
            Application.OpenURL("https://docs.google.com/document/d/1pIzIHIZ-cSh2ykODSZCbAPtScJ4Jpuu7lS3rNEHCLbc/edit#");
        }

        [MenuItem("Window/BOXOPHOBIC/Atmospheric Height Fog/Changelog", false, 2002)]
        ...
        [MenuItem("Window/BOXOPHOBIC/Atmospheric Height Fog/Write A Review", false, 3000)]

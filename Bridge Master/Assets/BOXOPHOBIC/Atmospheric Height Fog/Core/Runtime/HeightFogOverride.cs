...
namespace AtmosphericHeightFog
{
    ...
    public class HeightFogOverride : StyledMonoBehaviour
    {
        ...
        [Range(0f, 1f)]
        public float volumeGizmoVisibility = 0.2f;
        ...
        [StyledMessage("Info", "The Preset feature requires a material using the BOXOPHOBIC > Atmospherics > Fog Preset shader.", 5, 10)]
        ...
        void OnDrawGizmos()
        {
            Gizmos.color = new Color(fogColorStart.r, fogColorStart.g, fogColorStart.b, volumeGizmoVisibility);
        ...
        void SetLocalMaterial()
        {
            ...
            if (mainDirectional != null)
            {
                localMaterial.SetVector("_DirectionalDir", -mainDirectional.transform.forward);
            }
            else
            {
                localMaterial.SetVector("_DirectionalDir", Vector4.zero);
            }
